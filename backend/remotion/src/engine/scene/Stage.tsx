...
import { CAMERA_REST, cameraTransform, perspectiveFor, type CameraState } from "../motion/camera";
...
export const Stage: React.FC<{
  ...
  // A lens wins over an explicit distance, which wins over the default.
  const distance =
    camera.fov > 0 ? perspectiveFor(camera.fov, height) : (perspective ?? Math.max(width, height) * 1.6);
